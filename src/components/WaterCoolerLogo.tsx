...
const WaterCoolerLogo = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <pattern id="wc-hatch" patternUnits="userSpaceOnUse" width="2" height="2" patternTransform="rotate(45)">
        <line x1="0" y1="0" x2="0" y2="2" stroke="currentColor" strokeWidth="0.4" />
      </pattern>
    </defs>
